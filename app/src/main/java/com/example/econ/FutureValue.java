...
public class FutureValue extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View RootViewssac = inflater.inflate (R.layout.activity_future_value, container, false);
        ...
        button77ac.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty (pr1ac.getText ( ))) {
                    ...
                    double periodac = prr1ac * (1 + (prr2ac * prr3ac));
                    pr4ac.setText (String.valueOf (periodac));
