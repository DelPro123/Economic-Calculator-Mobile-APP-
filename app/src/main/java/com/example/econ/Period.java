...
public class Period extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View RootViewssac = inflater.inflate (R.layout.activity_period, container, false);
        ...
        button77ac.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty (pr1ac.getText ( ))) {
                    ...
                    double period = (( prr1ac/ prr2ac)-1)/ prr3ac;
                    pr4ac.setText (String.valueOf (period));
