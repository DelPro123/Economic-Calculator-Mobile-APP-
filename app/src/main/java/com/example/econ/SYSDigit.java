...
public class SYSDigit extends AppCompatActivity{
    EditText comp1an;
    EditText comp2an;
    EditText comp3an;
    TextView comp4an;
    ...
    onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_sysdigit);
        ...
        btn3an.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View v) {
                ...
                double n = (acan*(acan+1))/2;
                StringBuilder nn= new StringBuilder ();
                double ss=0;
                comp5an.setText (String.valueOf ("Period                         "+"Depreciation                    "+"Future Value                     "));
                for(ss=1;ss<=acan;ss++){
                    double d=(aaan-aban)*(ss-acan/n);


                    nn.append (String.valueOf (ss+"   "+d+"   "+(aaan-d)+"\n"));
